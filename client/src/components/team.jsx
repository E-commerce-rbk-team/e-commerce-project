...
const OurTeamPage = () => {
  const teamMembers = [
    { name: "Salim Hanechi", role: "Scrum Master", imageUrl: "https://media.discordapp.net/attachments/1186723460072865853/1187078114275250216/zi93snopf62wwwn5vnkn.jpg?ex=659593a5&is=65831ea5&hm=10cd0fa6c2f72adafd560d6eafc4932ebcc28adc3bbdb73e0aa5a8767639f5f8&=&width=663&height=597" },
    ...
    <div className="container">
      <div className="row heading">
        <div className="col-md-6 col-md-offset-3">
          <h2 id="text-center">Meet Our Team</h2>
            </div>
      </div>
