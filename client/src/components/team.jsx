...
const TeamMember = ({ name, role, imageUrl }) => (
  <div className="team-wrap">
    <div className="team-member text-center">
      ...
      <span className="dis">{role}</span>
    </div>
    <p id="des">
              We Worked Really Hard On This Project We Hope You Like It 
            </p>
  </div>
);
...
const OurTeamPage = () => {
  const teamMembers = [
    ...
    { name: "Tasnime ouertani ", role: "Web Developer", imageUrl: "https://media.discordapp.net/attachments/1173349023151833140/1187077926773063760/20221228_123913.jpg?ex=65959378&is=65831e78&hm=1c42b716a78cb1330c61f1fe7eb2d4ba90ac49e39ee058b3ffc4fe81a2d69e7e&=&width=447&height=597" },
  ];
