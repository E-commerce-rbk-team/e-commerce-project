...
const addresses = ['Cité Olympique ', 'Tunisia', 'Tunisia', '1003', 'Tunisia'];
const payments = [
  { name: 'Card type', detail: 'Visa' },
  { name: 'Card holder', detail: 'Mohamed Amine Merdessi' },
    ...
    <React.Fragment>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} sm={6}>
          ...
          <Typography gutterBottom>Mohamed Amine Merdessi</Typography>
